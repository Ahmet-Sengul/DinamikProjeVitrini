...
export const ADMINROUTES: RouteInfo[] = [
  ...
  { path: '/about', title: 'About', icon: 'info', class: '', claim: "GetLogDtoQuery" },
  { path: '/home-page', title: 'Home Page', icon: 'home', class: '', claim: "GetLogDtoQuery" },
  { path: '/tecnology', title: 'Technology', icon: 'apps', class: '', claim: "GetLogDtoQuery" },
  { path: '/contact', title: 'Contact', icon: 'grade', class: '', claim: "GetLogDtoQuery" },
  { path: '/member', title: 'Member', icon: 'grade', class: '', claim: "GetLogDtoQuery" },
  { path: '/contact-message', title: 'Contact Messages', icon: 'grade', class: '', claim: "GetLogDtoQuery" },
];
